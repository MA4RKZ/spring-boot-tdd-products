...
public class ComissaoTest {
    ...
    @Test
    public void deve_calcular_100_reais_de_comissao_para_venda_de_1000_com_10_porcento(){

      // Comissao comissao = new Comissao();
        Double valorVenda = 1000.00;
        Double valorComissao = 100.00;
        Double valorCalculado = comissao.calcular(valorVenda);
        org.junit.jupiter.api.Assertions.assertEquals(valorComissao, valorCalculado);
    }

    @Test
    public void deve_calcular_300_reais_de_comissao_para_venda_de_2000_com_15_porcento(){
